			...
			if(jsonData.message!=null)
				{
					...
					row.innerHTML="<td>"+details[0]+"</td><td>"+details[1]+"<td>"+details[3]+"</td><td><button class=\"btn btn-danger btn-sm\" onclick=\"sendInstructions('"+details[0]+"','ambulance','"+details[2]+"')\">Summon Ambulance</button><button type=\"button\" class=\"btn btn-primary btn-sm\" onclick=\"sendInstructions('"+details[0]+"','medication','"+details[2]+"')\">Suggest Medication</button></td>";
				}
		}
		function sendInstructions(username,message,ph)
		{
			console.log(ph);
			...
			{
				websocket.send(username+','+message+','+ph);	
			}
		}
	</script>
</body>
