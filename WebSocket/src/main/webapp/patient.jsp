...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" name="phno" id="phno" style="display:inline-block; width:300px;margin-top:25px;""></br>
	...
	<script>
		...
		function sendVitals()
		{
			websocket.send(vital.value+","+phno.value+","+temp.value);
			vital.value="";
			phno.value="";
			temp.value="";
		}
